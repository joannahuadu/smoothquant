...
class ActivationSparsityHook:
    ...
    def __init__(self, module: nn.Linear, act_sparsity_n: int, act_sparsity_m: int):
        """
    ...
    def apply_activation_sparsity(self, x):
        ...
        4. Column importance is derived from weight column norms
        ...
        # Get weight and apply percentile filtering and standardization
        ...
        # Compute importance metric for each activation
...
def apply_activation_sparsity_to_model(
    ...
    for name, module in model.named_modules():
        ...
        hook = ActivationSparsityHook(module, act_sparsity_n, act_sparsity_m)
